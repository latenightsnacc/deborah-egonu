                    ...
                    <div className="w-1/3 ">
                        ...
                        <h3 className="text-lg uppercase font-bold text-gray-900">languages</h3>
                            <div id="web-dev" className="my-2">
                                <h4 className="font-semibold  text-sm uppercase text-gray-900 py-2">Web Dev</h4>
                            ...
                            <div id="mobile-dev" className="my-2">
                                <h4 className="font-semibold  text-sm uppercase text-gray-900 py-2">Mobile Dev</h4>
                                <ul className="flex flex-row text-black text-sm font-medium">
                                    <li>Dart | &nbsp;</li>
                                    <li> Flutter | &nbsp; </li>
                                </ul>
