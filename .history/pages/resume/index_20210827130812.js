                ...
                <div className="w-full flex flex-row">
                    ...
                    <div className="w-1/3 ">
                        <div className="mb-3" id="contact-section">
                            <h3 className="text-lg uppercase text-gray-700">contact</h3>
                            <ul className="mt-2">
                        ...
                        <h3 className="text-lg uppercase text-gray-700">education</h3>
                            <div id="schoolOne" className="my-2">
                                ...
                                <p className="font-light text-base text-black">B.S.in Information Technology</p>
                            </div>
                            <div id="schoolOne" className="my-2">
                                <h4 className="font-semibold">BlueCrest University</h4>
                                <div className="text-sm text-gray-400 font-light py-1">
