                ...
                <h1 className="text-center pb-5 text-5xl font-bold text-gray-50">Start your journey</h1>
                    <form className="flex flex-row">
                        <div className="text-3xl  font-semibold text-gray-100">I,&nbsp;
                            ...
                            <select className="p-2 no-outline text-blue-600" required="true">
                                <option value="" selected>Select your path</option>
                                <option value="Web Developer">Web Developer</option>
                            </select>
                        </div>
                        <button className="bg-gray-50 ml-5 px-10 py-2 text-2xl text-blue-400 font-semibold rounded-2xl shadow-xl">Begin</button>
                    </form>
                </div>
            </section>
