        ...
        <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 grid-rows-auto">
                <div className="h-96 flex flex-col items-center justify-center relative group hover:bg-gray-50">
                    <h2 className="text-6xl mb-3 font-bold"><span className="text-blue-600">H</span><span className="text-yellow-300">T</span><span className="text-red-600">M</span><span className="text-green-600">L</span></h2>
                    <button className=" opacity-0 group-hover: bg-blue-500 py-3 px-10 rounded-xl text-gray-100 font-semibold tracking-widest ">Begin</button>   
                </div>
