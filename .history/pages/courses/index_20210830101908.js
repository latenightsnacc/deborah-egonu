            ...
            <section className="w-full  h-96">
                <div className="flex flex-row justify-center h-full items-center">
                    <blockquote className="text-center">
                        <q className=" text-blue-600 text-5xl flex flex-row font-bold h-auto items-center justify-start"><span className="text-7xl">To</span><span className="d-block">teach is to master <br/>&nbsp;&nbsp;&nbsp;learn is the journey.</span></q>
                    </blockquote>
                </div>
            </section>
