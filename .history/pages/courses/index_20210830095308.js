        ...
        <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 grid-rows-auto">
                <div className="h-96 flex flex-col items-center justify-center relative group hover:bg-gray-50">
                    <h2 className="text-6xl font-bold"><span className="text-blue-600">H</span><span className="text-yellow-300">T</span><span className="text-red-600">M</span><span>L</span></h2>
