        ...
        <>
            ...
            <section className="w-full  h-96">
                <div className="flex flex-row justify-center h-full items-center">
                    <div className="text-center">
                        <p className=" text-gray-900 text-3xl flex flex-row font-semibold h-auto items-center justify-start">To teach is to master <br/> and to learn is the journey.</p>
                    </div>
                </div>
            </section>
            <Spacer />
            <section className="bg-blue-500 h-96">
                ...
                <h1 className="text-center pb-5 text-5xl font-bold text-gray-50">Start your journey</h1>
                    <form>
                        <p className="text-2xl  font-semibold text-gray-100">I,&nbsp;
                            <span>
                                <input className="p-2 no-outline" type="text" placeholder="enter your name" />
                            </span> want to be a&nbsp;
                            <select className="p-2 no-outline text-blue-600">
