            ...
            <section className="w-full  h-96">
                <div className="flex flex-row justify-center h-full items-center">
                    <div className="text-center">
                        <p className=" text-green-400 text-3xl flex flex-row font-semibold h-auto items-center justify-start">To teach is to master <br/> and to learn is the journey.</p>
                    </div>
                </div>
            </section>
            <Spacer />
