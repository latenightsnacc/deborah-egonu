            ...
            <section className="bg-blue-500 h-96">
                ...
                <h1 className="text-center pb-5 text-5xl font-bold text-gray-50">Start your journey</h1>
                    <form className="flex flex-row">
                        ...
                        <button className="bg-gray-50 ml-5 px-10 py-2 text-2xl text-blue-500 w-56 rounded-2xl shadow-xl hover:shadow-2xl hover:bg-blue-400 hover:text-gray-50">Begin</button>
                    </form>
                </div>
            </section>
